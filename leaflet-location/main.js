...
module.exports = "div { position: absolute; width: 100%; height: 100%; }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.map = leaflet__WEBPACK_IMPORTED_MODULE_2__["map"]('map')
            .fitWorld();
        leaflet__WEBPACK_IMPORTED_MODULE_2__["tileLayer"]
            .provider('OpenStreetMap.Mapnik')
            .addTo(this.map);
        this.map.locate({ setView: true, maxZoom: 16 });
        this.map.on('locationfound', function (e) {
            var radius = e.accuracy / 2;
            leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"](leaflet__WEBPACK_IMPORTED_MODULE_2__["latLng"](e.latitude, e.longitude))
                .bindPopup('marker')
                .addTo(_this.map);
...
module.exports = __webpack_require__(/*! C:\Users\andre\Documents\dev\workspace\lab\leaflet-location\src\main.ts */"./src/main.ts");
